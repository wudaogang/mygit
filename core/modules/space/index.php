...
list(,$subjects) = $S->find('sid,name,subname,pid,catid,avgsort,reviews,pictures,thumb,addtime', $where, array('addtime' => 'DESC'), 0, $offset, FALSE);
