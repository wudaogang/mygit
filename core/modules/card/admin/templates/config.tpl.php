...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr id="tr_usercoin">
            	<td class="altbg1"><strong>申请会员卡扣除金币:</strong>当会员提交会员卡申请时，扣除会员的相应金币，如申请审核失败，则退还会员金币。</td>
                <td><input name="modcfg[coin]" type="text" class="txtbox5" value="<?=$modcfg['coin']?>" /> 金币</td>
            </tr>
            <tr>
