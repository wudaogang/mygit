    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            ...
            <tr>
                ...
                <td><a href="<?=url("item/detail/id/$val[sid]")?>" target="_blank"><?=$val['subjectname'].($val['subname']?"($val[subname])":'')?></a></td>
				<td><?=$val['num']?></td>
			...
			<?endwhile;?>
			<tr class="altbg1">
				<td colspan="8"><button type="button" onclick="checkbox_checked('picids[]');" class="btn2">全选</button></td>			</tr>
			<?else:?>
			<tr>
