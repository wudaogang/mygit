...
<?=form_begin(cpurl($module,$act,$op))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td class="altbg1"><strong>是否启用 STMP 方式发送邮件:</strong>如果服务器支持PHP的 mail 函数，则不需要进行设置</td>
                <td>
                    <?=form_bool('setting[mail_use_stmp]',$config['mail_use_stmp'])?>
                </td>
            </tr>
            <tr>
                <td class="altbg1"><strong>STMP 服务器:</strong>尽量不要使用免费邮箱，一般都有发送限制</td>
                <td><input type="text" class="txtbox" name="setting[mail_stmp]" value="<?=$config['mail_stmp']?>" /></td>
            </tr>
            <tr>
                <td class="altbg1"><strong>STMP 服务器端口:</strong>默认为端口为25</td>
