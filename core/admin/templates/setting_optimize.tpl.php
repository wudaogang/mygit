...
<?=form_begin(cpurl($module,$act,$op))?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                <td class="altbg1" class="altbg1"><strong>整页缓存时间</strong>开启整页缓存，可PHP文件的载入数量和数据库操作，加快服务器响应，0为不开启。</td>
                <td><input type="text" name="setting[page_cachetime]" value="<?=$config['page_cachetime']?>" class="txtbox5" />&nbsp;秒</td>
            </tr>
        </table>
    </div>
