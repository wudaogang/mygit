...
></div>
            ...
            <div class="info">
                ...
                <div class="content" id="content"<? if($catcfg['detail_content_hide']) { ?>
 style="display:none;"<? } ?>
><?=$detail['content']?></div>
            </div>
            <? } ?>
...
$_QUERY[$_G['modoer_datacall']['16']['var']] = $_G['datacall']->datacall_sql(16);
 if(empty($_QUERY[$_G['modoer_datacall']['16']['var']])) { include template($_G['modoer_datacall']['16']['empty_tplname'],'datacall'); } else { include template($_G['modoer_datacall']['16']['tplname'],'datacall'); } ?>
    </div>
    <? } ?>
