                        ...
                        <td width="*">
							...
							<script type="text/javascript">
								$('#subject_search').item_subject_search({
									...
									myreviewed:true,
									myfavorite:true,
                                    location:"<?php echo url("item/member/ac/{$ac}/sid/_SID_"); ?>"
								});
							</script>
                        </td>
                    </tr>
...
<? } elseif($_GET['op'] == 'multi') { ?>
                ...
                </table><?php $_G['loader']->helper('form','item');
                    ...
                    <div id="up_1" class="up_foo">
                        <form method="post" name="myform[]" action="<?php echo url("item/member/ac/{$ac}/in_ajax/1"); ?>" target="iframe_upload" enctype="multipart/form-data">
                            ...
                            <div style="margin:5px;padding:0 10px;">
								<p>
                                    所属相册：<select name="albumid"><?php echo $album_option; ?></select>
...
<? } else { ?>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" class="maintable">
                    ...
                    <tr>
                        ...
                        <td>
							<select name="albumid" id="albumid"><?php echo form_item_alubm($sid, $albumid); ?></select>
                            <? if($access_create_album) { ?>
<button type="button" onclick="item_create_album($('#albumid'));">新建相册</button><? } ?>
</td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
